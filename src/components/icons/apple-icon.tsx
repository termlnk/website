...
export function AppleIcon({ size = 16, className, style }: IAppleIconProps) {
  return (
    <svg className={className} width={size} height={size} viewBox="0 0 814 1000" fill="currentColor" style={style}>
